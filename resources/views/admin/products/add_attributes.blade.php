          		...
          		<div class="control-group">
               	...
               	<div class="control-group">
            		...
            		<div class="field_wrapper">
        				...
        				<a href="javascript:void(0);" class="btn btn-success btn-mini add_button" title="Add field">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a rel="{{ $attribute->id }}" rel1="delete-attribute" href="deleteRecord:" class="btn btn-danger btn-mini deleteAtRecord">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
