              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/add-attributes/'.$product->id) }}" class="btn btn-primary btn-mini">Add</a>
                    <a href="{{ url('/admin/edit-product/'.$product->id) }}" class="btn btn-info btn-mini">Edit</a>
                  	<a rel="{{ $product->id }}" rel1="delete-product" <?php /* href="{{ url('/admin/delete-product/'.$product->id)}}" */?> href="deleteRecord:" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                  </td>
                </tr>
