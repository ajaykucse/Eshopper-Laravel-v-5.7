          		...
          		<div class="control-group">
            		...
            		<div class="controls">
              		...
              		<div class="control-group">
                		...
                		<div class="controls">
                  			<textarea type="text" name="description" id="description">{{ $productDetails->product_name}}</textarea>
                		</div>
              		</div>
              		<div class="control-group">
          			...
          			<div class="control-group">
              			...
              			<div class="controls">
                			...
                			<img src="{{ asset('/backend/images/products/small/'.$productDetails->image)}}" style="width:40px;">  <a class="btn btn-danger btn-mini" href="{{ url('/admin/delete-product-image/'.$productDetails->id)}}">Delete</a>
                			@endif
              			</div>
            		</div>
