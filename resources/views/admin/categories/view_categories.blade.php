              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center"><a href="{{ url('/admin/edit-category/'.$category->id)}}" class="btn btn-primary btn-mini">Edit</a>
                    <a rel="{{ $category->id }}" rel1="delete-category" <?php /* href="{{ url('/admin/delete-product/'.$product->id)}}" */?> href="deleteCatRecord:" class="btn btn-danger btn-mini deleteCatRecord">Delete</a>
