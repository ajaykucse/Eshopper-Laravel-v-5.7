...
$(document).ready(function(){
	...
	$(document).on('click','.deleteCatRecord',function(e){
    var id = $(this).attr('rel');
    var deleteCatFunction = $(this).attr('rel1');
    swal({
      title: "Are you sure?",
    ...
    function(){
        window.location.href="/admin/"+deleteCatFunction+"/"+id;
    });
});
    ...
    //confirmation delete category
    $(document).on('click','.deleteAtRecord',function(e){
        var id = $(this).attr('rel');
        var deleteAtFunction = $(this).attr('rel1');
        swal({
          title: "Are you sure?",
          text: "Your will not be able to recover this Record Again!",
          type: "warning",
        ...
        function(){
            window.location.href="/admin/"+deleteAtFunction+"/"+id;
        });
    });
